...
def extrair_padroes(arquivo_excel):
    ...
    for _, row in df_padroes.iterrows():
        ...
        for pos in range(1, 65):
            ...
            # O participio fode tudo
            else:
                col_numero_nome = f"Coluna{pos * 2 + 2}"
            ...
            if pd.notna(terminacao):
                ...
                if pos == 63 or pos == 64:
                    print(f"terminacao imperativo {padrao_id} eh {terminacao}")
    ...
    resultado["AR"]["terminacoes"]["imperativo_tu"] = {}
    resultado["AR"]["terminacoes"]["imperativo_vos"] = {}
    resultado["ER"]["terminacoes"]["imperativo_tu"] = {}
    resultado["ER"]["terminacoes"]["imperativo_vos"] = {}
    resultado["IR"]["terminacoes"]["imperativo_tu"] = {}
    resultado["IR"]["terminacoes"]["imperativo_vos"] = {}
